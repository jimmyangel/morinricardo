...
|[Amazon Web Services (AWS)](https://aws.amazon.com/)|We use [S3](https://aws.amazon.com/s3/) to store <u>public</u> GIS files for download, as well as <u>private</u> files such as surveys responses. [Lambda functions](https://aws.amazon.com/lambda/) (via [Netlify functions](https://www.netlify.com/products/functions/)) provide secure interfaces to maintain and access these files. [Batch jobs](https://aws.amazon.com/batch/) are used to generate map tiles used to visualize the GIS data sets on the application map. AWS services are not free, but with the modest level of usage anticipated for this application, the cost should be very affordable, perhaps under $1 a month. S3 storage services are quite inexpensive and computational resources are only allocated when used.|
